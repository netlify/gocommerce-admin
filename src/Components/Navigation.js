...
const menuItems = [
  {
    name: "Orders",
    href: "/orders",
    icon: <BasketIcon className="basket-icon" size={16} color="currentColor" />
  },
  {
    name: "Customers",
    href: "/customers",
    icon: <PeopleIcon className="People-icon" size={16} color="currentColor" />
  },
  {
    name: "Reports",
    href: "/",
    icon: <PollIcon className="poll-icon" size={16} color="currentColor" />
  }
];
